...
int loadSettings() {
	...
	g_dipSwitch0 = cfg.dipSwitchDD0;
	g_dipSwitch1 = cfg.dipSwitchDD1;
	g_dipSwitch2 = cfg.dipSwitchDD2;
	g_dipSwitch3 = cfg.dipSwitchDD3;
...
void saveSettings() {
	...
	cfg.dipSwitchDD0 = g_dipSwitch0;
	cfg.dipSwitchDD1 = g_dipSwitch1;
	cfg.dipSwitchDD2 = g_dipSwitch2;
	cfg.dipSwitchDD3 = g_dipSwitch3;
